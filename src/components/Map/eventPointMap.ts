...
const entries: Array<[string, string]> = [
  ...
  ["Third Preaching Tour Of Galilee::5", "Capernaum"],
  ...
  ["Jesus Preaches And Heals In Syrian Phoenicia Iturea And Trachonitis The Decapolis::2", ""],
  ["Jesus Preaches And Heals In Syrian Phoenicia Iturea And Trachonitis The Decapolis::3", ""],
  ...
  ["Jesus Preaches And Heals In Syrian Phoenicia Iturea And Trachonitis The Decapolis::7", ""],
  ["Jesus Preaches And Heals In Syrian Phoenicia Iturea And Trachonitis The Decapolis::8", ""],

  ["Later Ministry In Judea::0", "Jerusalem"],
  ["Later Ministry In Judea::1", "Jerusalem"],
  ["Later Ministry In Judea::2", ""],

  ["The Last Few Months::0", "Jerusalem"],
  ["The Last Few Months::1", "Jerusalem"],
  ["The Last Few Months::2", "Ephraim"],

  ["His Ministry In Perea Modern Jordan::0", ""],
